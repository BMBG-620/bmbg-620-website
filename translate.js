const translations = {
  en: {
    ...
    intro: "Complete the form below and send your application to the State 620 leadership team.",
    username: "Username / in-game name",
    gameId: "In-game ID",
  ...
  ko: {
    title: "이민 신청서",
    intro: "아래 양식을 작성하여 State 620 리더십 팀에 신청서를 보내주세요.",
    username: "사용자 이름 / 게임 내 이름",
    gameId: "게임 ID",
    currentState: "현재 서버",
    currentClan: "현재 클랜",
  ...
  "zh-TW": {
    title: "移民申請",
    intro: "請填寫以下表格，並將您的申請提交給 620 州領導團隊。",
    username: "使用者名稱 / 遊戲名稱",
    gameId: "遊戲 ID",
    currentState: "目前州",
    currentClan: "目前聯盟",
  ...
  "zh-CN": {
    title: "移民申请",
    intro: "请填写以下表格，并将您的申请提交给 620 州领导团队。",
    username: "用户名 / 游戏名称",
    gameId: "游戏 ID",
    currentState: "当前州",
    currentClan: "当前联盟",
  ...
  ja: {
    title: "移民申請",
    intro: "以下のフォームに記入し、State 620のリーダーチームに申請を送信してください。",
    username: "ユーザー名 / ゲーム内の名前",
    gameId: "ゲームID",
  ...
  th: {
    title: "ใบสมัครย้ายรัฐ",
    intro: "กรอกแบบฟอร์มด้านล่างและส่งใบสมัครของคุณให้ทีมผู้นำ State 620",
    username: "ชื่อผู้ใช้ / ชื่อในเกม",
    gameId: "ไอดีในเกม",
    currentState: "รัฐปัจจุบัน",
    currentClan: "แคลนปัจจุบัน",
  ...
  es: {
    title: "SOLICITUD DE MIGRACIÓN",
    intro: "Completa el formulario y envía tu solicitud al equipo de liderazgo del Estado 620.",
    username: "Usuario / nombre en el juego",
    gameId: "ID del juego",
    currentState: "Estado actual",
    currentClan: "Clan actual",
  ...
  pt: {
    ...
    intro: "Preencha o formulário abaixo e envie a sua candidatura à liderança do Estado 620.",
    username: "Utilizador / nome no jogo",
    gameId: "ID do jogo",
    currentState: "Estado atual",
    currentClan: "Clã atual",
  ...
  fr: {
    title: "DEMANDE DE MIGRATION",
    intro: "Remplissez le formulaire ci-dessous et envoyez votre candidature à l'équipe dirigeante de l'État 620.",
    username: "Nom d'utilisateur / nom en jeu",
    gameId: "ID du jeu",
  ...
  de: {
    title: "MIGRATIONSBEWERBUNG",
    intro: "Fülle das Formular aus und sende deine Bewerbung an das Führungsteam von State 620.",
    username: "Benutzername / Name im Spiel",
    gameId: "Spiel-ID",
    currentState: "Aktueller Staat",
    currentClan: "Aktueller Clan",
  ...
  it: {
    title: "DOMANDA DI MIGRAZIONE",
    intro: "Compila il modulo e invia la tua candidatura al team di leadership dello Stato 620.",
    username: "Nome utente / nome nel gioco",
    gameId: "ID di gioco",
    currentState: "Stato attuale",
    currentClan: "Clan attuale",
  ...
  tr: {
    title: "GÖÇ BAŞVURUSU",
    intro: "Aşağıdaki formu doldurun ve başvurunuzu State 620 liderlik ekibine gönderin.",
    username: "Kullanıcı adı / oyun içi isim",
    gameId: "Oyun ID",
    currentState: "Mevcut eyalet",
    currentClan: "Mevcut klan",
  ...
  ru: {
    ...
    intro: "Заполните форму ниже и отправьте заявку руководству State 620.",
    username: "Имя пользователя / имя в игре",
    gameId: "Игровой ID",
    currentState: "Текущий штат",
    currentClan: "Текущий клан",
  ...
  ar: {
    title: "طلب الهجرة",
    intro: "أكمل النموذج أدناه وأرسل طلبك إلى فريق قيادة State 620.",
    username: "اسم المستخدم / الاسم داخل اللعبة",
    gameId: "معرّف اللعبة",
    currentState: "الولاية الحالية",
    currentClan: "التحالف الحالي",
  ...
  vi: {
    title: "ĐƠN ĐĂNG KÝ DI CƯ",
    intro: "Điền biểu mẫu bên dưới và gửi đơn đăng ký đến đội ngũ lãnh đạo State 620.",
    username: "Tên người dùng / tên trong game",
    gameId: "ID trong game",
    currentState: "State hiện tại",
    currentClan: "Clan hiện tại",
  ...
  id: {
    title: "APLIKASI MIGRASI",
    intro: "Lengkapi formulir di bawah dan kirim aplikasi Anda kepada tim kepemimpinan State 620.",
    username: "Nama pengguna / nama dalam game",
    gameId: "ID dalam game",
    currentState: "State saat ini",
    currentClan: "Clan saat ini",
